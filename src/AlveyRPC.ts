import { AlveyRPCRaw } from "./AlveyRPCRaw"
...
/**
 * Transaction receipt returned by alveyd
 */
...
/**
 * The raw log data returned by alveyd, not ABI decoded.
 */
...
export class AlveyRPC extends AlveyRPCRaw {
